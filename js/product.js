...
document.addEventListener("DOMContentLoaded",function(){
    ...
    // console.log(color);
    document.querySelector("div.mainpic").style['background-image']  = 'url(./product/fender-midnight-stratocaster.png)';
    ...
    document.querySelector("div.mainpic").style['background-image']  = 'url(./product/ok.png)';
    color.innerHTML = "MIAMI BLUE/MAPLE WOOD";
    })
    let btn3 = document.querySelector("button#btn3");
    btn3.addEventListener("click",function(){
    document.querySelector("div.mainpic").style['background-image']  = 'url(./product/1_rr.png)';
    color.innerHTML ="FIESTA RED/MAPLE WOOD"
    })
    let btn4 = document.querySelector("button#btn4");
    btn4.addEventListener("click",function(){
    document.querySelector("div.mainpic").style['background-image']  = 'url(./product/yes.png)';
